...
export default class ModalConfirm extends AbstractView {
  ...
  get template() {
    return `
    <section class="modal">
      <button class="modal__close" type="button" tabindex="1"><span class="visually-hidden">Закрыть</span></button>
      <h2 class="modal__title">Подтверждение</h2>
      <p class="modal__text">Вы уверены что хотите начать игру заново?</p>
      <div class="modal__buttons">
        <button class="modal__button button" tabindex="2">Ок</button>
        <button class="modal__button button" tabindex="3">Отмена</button>
      </div>
    </section>
    `.trim();
  }
